...
1.1 Specifically, I did: `curl -L -O http://3dvision.princeton.edu/projects/2014/3DShapeNets/ModelNet10.zip`
1.2 Then unzip: `unzip ModelNet10.zip`
1.3. Delete tehe __MACOSX.

2. Run modelnet40_2Dgen.py to generate 2D views: `python modelnet40_2Dgen.py`
